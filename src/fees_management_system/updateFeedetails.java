...
public class updateFeedetails extends javax.swing.JFrame {
    ...
    public void setRecords() {
        ...
        try {
            ...
            combobox_paymentmode.setSelectedItem(rs.getString("payment_mode"));
    ...
    public String updateData() {
        ...
        try {
            ...
            Connection con = DB_Conn.getConnection();
            PreparedStatement pst = con.prepareStatement("update fees_details set student_name=?,payment_mode=?,cheque_no=?,bank_name=?,dd_no=?,courses=?,gstin=?,total_amount=?,date=?,amount=?,cgst=?,sgst=?,total_in_words=?,remark=?,year1=?,year2=?,roll_no=? where receipt_no=?");
    ...
    private void initComponents() {
        ...
        panelParent.add(txt_chequeno, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 150, 200, 30));
        ...
        jPanel1.add(txt_year1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 50, 70, 30));

        jLabel11.setText("     __");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 50, 30, -1));
        ...
        jPanel1.add(txt_year2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 50, 80, 30));
        ...
        jPanel1.add(btn_print, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 510, 90, 30));
        ...
        panelParent.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 0, 120, -1));

        getContentPane().add(panelParent, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 1480, -1));

        setSize(new java.awt.Dimension(2035, 950));
